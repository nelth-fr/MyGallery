...
To build the final jar and optimize the MyGallery application for production, run:
...
You can use Docker to improve your JHipster development experience. A number of docker-compose configuration are available in the [src/main/docker](main/docker) folder to launch required third party services.
