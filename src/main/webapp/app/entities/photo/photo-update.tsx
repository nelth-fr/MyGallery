...
export class PhotoUpdate extends React.Component<IPhotoUpdateProps, IPhotoUpdateState> {
  ...
  render() {
    const { photoEntity, albums, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="myGalleryApp.photo.home.createOrEditLabel">Create or edit a Photo</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : photoEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="photo-title" type="text" name="title" />
                </AvGroup>
                <AvGroup>
